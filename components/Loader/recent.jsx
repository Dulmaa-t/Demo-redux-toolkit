const RecentWorkL = ({isMarket}) => {
    ...
    return (
        <div className={`${isMarket ? 'h-[500px]' : 'h-full'} w-full font-open flex animate-pulse border flex-col`}>
                ...
                <div className="w-full flex flex-col text-left p-4 h-full">
                    ...
                    <div className="flex-1 flex flex-col md:flex-row items-stretch">
                        <div className="flex flex-1 w-full items-center">
                            <div className="w-5 h-5 md:w-10 md:h-10 relative overflow-hidden rounded-full bg-gray-200"></div>
                            <p className="ml-2 text-[#444] text-base md:text-lg truncate flex-1 p-2 w-[50px] bg-gray-300 sm:text-lg font-open font-[400]"></p>
                        </div>
                        <div className="flex gap-2 justify-end w-full items-center">
                            <div className="flex h-6 w-[70px] items-center bg-gray-300">
                                <p className={`text-base font-poppins text-[#555] md:text-base ml-px`}></p>
                            </div>
